...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bf4458, const void *arg_0xb7bf45f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7ba58c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a4f840), 
int (*key_eq_fn)(void *arg_0xb7a4fc88, void *arg_0xb7a4fe00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb791e9b8, int arg_0xb791eb10);
static double RandomUniform(void );
...
#line 130
static error_t Challenge4C$SplitControl$stop(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t Challenge4C$Ack$requestAck(
#line 53
message_t * msg);
#line 85
static bool Challenge4C$Ack$wasAcked(
#line 80
message_t * msg);
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
static am_addr_t Challenge4C$AMPacket$source(
#line 84
message_t * amsg);
# 35 "Challenge4C.nc"
...
am_addr_t Challenge4C$sender_addr[1000];
...
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static am_addr_t Challenge4C$AMPacket$source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
#line 164
  ...
  if (TOS_NODE_ID == 2) {
      Challenge4C$counter[sim_node()] = __nesc_ntoh_uint16(message_received->msg_counter.nxdata);
      Challenge4C$sender_addr[sim_node()] = Challenge4C$AMPacket$source(buf);
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76c1ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76c1ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76c1ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76be178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76be178, msg, payload, len);
#line 78
...
#line 87
{
  ...
  sim_log_debug(149U, "split-control", "\nApplication stopped");
}
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76c1108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76c1108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb75666a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb75666a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb75666a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb787a650){
#line 75
  switch (arg_0xb787a650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb787a650);
#line 75
      break;
#line 75
    }
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t Challenge4C$Ack$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
#line 93
{
  ...
  if (Challenge4C$locked[sim_node()]) {
      ...
      my_msg_t *message = (my_msg_t *)Challenge4C$Packet$getPayload(&Challenge4C$packet[sim_node()], sizeof(my_msg_t ));
...
#line 103
      ...
      __nesc_hton_uint16(message->msg_counter.nxdata, Challenge4C$counter[sim_node()]);
      __nesc_hton_uint8(message->value.nxdata, 0);
      if (Challenge4C$Ack$requestAck(&Challenge4C$packet[sim_node()]) == SUCCESS) {
          sim_log_debug(150U, "radio_ack", "Acks enabled");
        }

      if (Challenge4C$AMSend$send(AM_BROADCAST_ADDR, &Challenge4C$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
...
#line 175
{
  ...
  if (!Challenge4C$locked[sim_node()] && result == SUCCESS) {
      ...
      __nesc_hton_uint16(message->msg_counter.nxdata, Challenge4C$counter[sim_node()]);
      __nesc_hton_uint8(message->value.nxdata, data);
      if (Challenge4C$Ack$requestAck(&Challenge4C$packet[sim_node()]) == SUCCESS) {
          sim_log_debug(155U, "radio_ack", "Acks enabled");
        }
      if (Challenge4C$AMSend$send(Challenge4C$sender_addr[sim_node()], &Challenge4C$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          Challenge4C$locked[sim_node()] = TRUE;
        }
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73e73a8){
#line 83
  switch (arg_0xb73e73a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73e73a8);
#line 83
      break;
#line 83
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb75650a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb75650a0, addr, msg, len);
#line 80
...
inline static bool Challenge4C$Ack$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
inline static error_t Challenge4C$SplitControl$stop(void ){
#line 130
  unsigned char __nesc_result;
#line 130
...
#line 134
      sim_log_debug(151U, "radio_send", "\nType: %u, \nCounter: %u, \nValue: %u", __nesc_ntoh_uint16(sent_msg->msg_type.nxdata), __nesc_ntoh_uint16(sent_msg->msg_counter.nxdata), __nesc_ntoh_uint8(sent_msg->value.nxdata));
      Challenge4C$locked[sim_node()] = FALSE;
      if (Challenge4C$Ack$wasAcked(buf) && TOS_NODE_ID == 1) {
          Challenge4C$MilliTimer$stop();
          sim_log_debug(152U, "radio_ack", "\nAcked");
        }
      else {
#line 140
        if (Challenge4C$Ack$wasAcked(buf) && TOS_NODE_ID == 2) {
            sim_log_debug(153U, "radio_ack", "OK");
            Challenge4C$SplitControl$stop();
          }
        else {
            if (Challenge4C$AMSend$send(AM_BROADCAST_ADDR, buf, sizeof(my_msg_t )) == SUCCESS) {
                Challenge4C$locked[sim_node()] = TRUE;
              }
            sim_log_debug(154U, "radio_ack", "\nNot Acked");
          }
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "Challenge4C$sender_addr"))
  {
    *addr = (uintptr_t)&Challenge4C$sender_addr[__nesc_mote];
    *size = sizeof(Challenge4C$sender_addr[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&Challenge4C$sender_addr[__nesc_mote], 0, sizeof Challenge4C$sender_addr[__nesc_mote]);
